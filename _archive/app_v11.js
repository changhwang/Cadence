...
function renderWorkoutBuilder(container) {
    ...
    header.style.marginBottom = '20px'; // Spacing push

    header.innerHTML = `
        <div style="font-size:20px; font-weight:800;">Daily Log</div>
        <div onclick="openCalendarModal()" style="font-size:16px; font-weight:600; cursor:pointer; color:var(--ios-blue); display:flex; align-items:center; gap:5px;">
            ${state.date} <i data-lucide="chevron-down" style="width:16px; height:16px;"></i>
        </div>
        <button onclick="openCalendarModal()" style="background:none; border:none; color:var(--ios-blue);">
